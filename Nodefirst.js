...
var bot_token = '5157947444:AAHnGfmBmo7N-7JYMSQXK7y3Hn8mkXUtW8Q'; //YOUR BOT TOKEN HERE
var bot_name = 'no_de_js_mybot'; // Bot Name
...
const admin_id = 1087657480;
const admin_id2 = 1225460233;
        ...
        if (bots == 'Active') {
            ...
            if (flag == channel.length) {
                ...
                if (statdata.length == 0) {
                    ...
                    ctx.reply(
                        '<b>📊 Bot Live Stats 📊\n\n📤 Total Payouts : 0 ' + currency + '\n\n💡 Total Users: ' + members.length + ' Users\n\n✅ Created By : <a href="tg://user?id=1087657480">Legend Coder</a></b>' , { parse_mode: 'html', reply_markup: { keyboard: [['💰 Balance'], ['👫 Invite', '🎁 Bonus', '🗂 Wallet'], ['💵 Withdraw', '📊 Statistics']], resize_keyboard: true } }
                    )
                } else {
